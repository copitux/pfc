...
{/section}
		...
		<h3>Opciones</h3>
		<div id="opciones">
			<span class="nueva_carpeta"><a href="index.php?route=student/newFolder&path={$rute_to_up}">Crear Carpeta</a></span>
			<span class="upload"><a href="index.php?route=student/upFile&path={$rute_to_up}">Subir archivo</a></span>
			<!--<a href="#">Buscar</a>-->
		</div>
